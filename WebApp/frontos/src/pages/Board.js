...
//             // Filter out any null responses due to errors
//             const validData = dataArray.filter((data) => data !== null);
//             setWorkInfo(validData); // Set the array of people information
...
//                     <div className="insert-option">
//                         <textarea
//                             placeholder="Insert work here, separated by (;)"
//                             className="option-input"
//                             value={workInput}
//                             onChange={(e) => setWorkInput(e.target.value)}
//                         />
//                         <button onClick={handleFetchWorks}>Insert Work</button>
//                     </div>
//                     {/* People */}
//                     <div className="insert-option">
//                         <textarea
